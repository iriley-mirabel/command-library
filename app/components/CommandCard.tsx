...
import { CommandMetadata } from '@/lib/commands';
...
export default function CommandCard({ command, category }: CommandCardProps) {
  ...
  return (
    <Link href={`/command/${command.id}`}>
      <div className="group p-6 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 hover:shadow-lg transition-all cursor-pointer h-full flex flex-col">
